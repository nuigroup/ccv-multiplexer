...
class ofxNCoreVision : public ofxGuiListener, public ofxTCPSyncClientListener
{
	// ofxGUI setup stuff
	enum
	{
...
public:
	...
	*******************************************************/
	...
	//Frame Sequecing and connection with TCPSync server
	ofxTCPSyncClient syncClient;
	void	frameEvent();
