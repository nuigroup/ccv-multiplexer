...
//	controls->update(appPtr->optionPanel_tuio_height_width, kofxGui_Set_Bool, &appPtr->myTUIO.bHeightWidth, sizeof(bool));
	...
	//CCVMultiplexer
	controls->update(appPtr->TCPSyncPanel_activate, kofxGui_Set_Bool, &appPtr->bTCPSync, sizeof(bool));
...
void ofxNCoreVision::addMainPanels() 
{
	...
	oPanel->addButton(appPtr->TCPSyncPanel_activate, "CCVMultiplexer", OFXGUI_BUTTON_HEIGHT, OFXGUI_BUTTON_HEIGHT, kofxGui_Button_Off, kofxGui_Button_Switch);
	oPanel->mObjWidth = 200;
	oPanel->mObjHeight = 110;

	// Templates


	// Transforms
	ofxGuiPanel* propPanel = controls->addPanel(appPtr->propertiesPanel, "Transforms", MAIN_PANEL_SECOND_X, 290 - (bcamera ? 0 : 80), 12, OFXGUI_PANEL_SPACING);
	...
	// Tracking
	ofxGuiPanel* trackingPanel = controls->addPanel(appPtr->trackingPanel, "Track", MAIN_PANEL_SECOND_X, 370 -(bcamera ? 0 : 80), OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	...
	//CCVMultiplexer - Included in Communication
	//ofxGuiPanel* TCPSyncPanel = controls->addPanel(appPtr->TCPSyncPanel, "CCVMultiplexer", MAIN_PANEL_SECOND_X, 455 -(bcamera ? 0 : 80), OFXGUI_PANEL_BORDER, OFXGUI_PANEL_SPACING);
	//TCPSyncPanel->addButton(appPtr->TCPSyncPanel_activate, "Activate", OFXGUI_BUTTON_HEIGHT, OFXGUI_BUTTON_HEIGHT, kofxGui_Button_Off, kofxGui_Button_Switch);
